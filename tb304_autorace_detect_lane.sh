...
scp camera.yaml tb304@10.42.0.104:/home/tb304/catkin_ws/src/turtlebot3_autorace/turtlebot3_autorace_camera/calibration/camera_calibration &

#raspi_camera
ssh tb304@10.42.0.104 'source /opt/ros/kinetic/setup.bash && export ROS_MASTER_URI=http://10.42.0.1:11311 && export ROS_HOSTNAME=10.42.0.104 && source ~/catkin_ws/devel/setup.bash && ~/catkin_ws/src/tb3_shell_scripts/./raspi_camera.sh' &
...
ssh tb304@10.42.0.104 'source /opt/ros/kinetic/setup.bash && export ROS_MASTER_URI=http://10.42.0.1:11311 && export ROS_HOSTNAME=10.42.0.104 && source ~/catkin_ws/devel/setup.bash && ~/catkin_ws/src/tb3_shell_scripts/./instrinsic_camera.sh' &
